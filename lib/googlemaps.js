...
exports.placeDetailsByPlaceId = function(placeId, key, sensor, language, callback) {
  var args = {
    placeid: placeId,
    key: key
  };
  if (lang) args.language = language;
  args.sensor = sensor || 'false';
...
exports.placeDetails = function(referenceId, key, callback, sensor, language) {
  var args = {
